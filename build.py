...
def build_contact():
    ...
    <section class="tight">
      <div class="wrap">
        ...
        <p class="empty-note" style="margin-top:28px;">
          [FILL, optional: add a Calendly or similar scheduling link here if you're actively
          interviewing &mdash; it removes an email round-trip for a recruiter trying to book time.]
        </p>
      </div>
    </section>
  </main>
